...
impl Action {
    ...
    fn parse_next_special(consumer: &mut ActionBuilder, state: SpecialBroadState) -> Result<Action, ParseError> {
        ...
        match state {
            ...
            DonkeyKong    (state) => state.parse_special(consumer), 
            Fox           (state) => state.parse_special(consumer), 
            MrGameAndWatch(state) => state.parse_special(consumer), 
            Kirby         (state) => state.parse_special(consumer), 
            Bowser        (state) => state.parse_special(consumer), 
            Link          (state) => state.parse_special(consumer), 
            Luigi         (state) => state.parse_special(consumer), 
            Mario         (state) => state.parse_special(consumer), 
            Marth         (state) => state.parse_special(consumer), 
            Mewtwo        (state) => state.parse_special(consumer), 
            Ness          (state) => state.parse_special(consumer), 
            Peach         (state) => state.parse_special(consumer), 
            Pikachu       (state) => state.parse_special(consumer), 
            IceClimbers   (state) => state.parse_special(consumer), 
            Jigglypuff    (state) => state.parse_special(consumer), 
            Samus         (state) => state.parse_special(consumer), 
            Yoshi         (state) => state.parse_special(consumer), 
            Zelda         (state) => state.parse_special(consumer), 
            Sheik         (state) => state.parse_special(consumer), 
            Falco         (state) => state.parse_special(consumer), 
            YoungLink     (state) => state.parse_special(consumer), 
            DrMario       (state) => state.parse_special(consumer), 
            Roy           (state) => state.parse_special(consumer), 
            Pichu         (state) => state.parse_special(consumer), 
            Ganondorf     (state) => state.parse_special(consumer), 
        }
    }
    ...
    fn parse_jumping_special(consumer: &mut ActionBuilder, state: SpecialBroadState, jump_type: JumpType) -> Result<Action, ParseError> {
        ...
        match state {
            ...
            DonkeyKong    (state) => state.parse_jumping_special(consumer, jump_type), 
            Fox           (state) => state.parse_jumping_special(consumer, jump_type), 
            MrGameAndWatch(state) => state.parse_jumping_special(consumer, jump_type), 
            Kirby         (state) => state.parse_jumping_special(consumer, jump_type), 
            Bowser        (state) => state.parse_jumping_special(consumer, jump_type), 
            Link          (state) => state.parse_jumping_special(consumer, jump_type), 
            Luigi         (state) => state.parse_jumping_special(consumer, jump_type), 
            Mario         (state) => state.parse_jumping_special(consumer, jump_type), 
            Marth         (state) => state.parse_jumping_special(consumer, jump_type), 
            Mewtwo        (state) => state.parse_jumping_special(consumer, jump_type), 
            Ness          (state) => state.parse_jumping_special(consumer, jump_type), 
            Peach         (state) => state.parse_jumping_special(consumer, jump_type), 
            Pikachu       (state) => state.parse_jumping_special(consumer, jump_type), 
            IceClimbers   (state) => state.parse_jumping_special(consumer, jump_type), 
            Jigglypuff    (state) => state.parse_jumping_special(consumer, jump_type), 
            Samus         (state) => state.parse_jumping_special(consumer, jump_type), 
            Yoshi         (state) => state.parse_jumping_special(consumer, jump_type), 
            Zelda         (state) => state.parse_jumping_special(consumer, jump_type), 
            Sheik         (state) => state.parse_jumping_special(consumer, jump_type), 
            Falco         (state) => state.parse_jumping_special(consumer, jump_type), 
            YoungLink     (state) => state.parse_jumping_special(consumer, jump_type), 
            DrMario       (state) => state.parse_jumping_special(consumer, jump_type), 
            Roy           (state) => state.parse_jumping_special(consumer, jump_type), 
            Pichu         (state) => state.parse_jumping_special(consumer, jump_type), 
            Ganondorf     (state) => state.parse_jumping_special(consumer, jump_type), 
        }
    }
